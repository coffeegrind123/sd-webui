...
class Api:
    ...
    # Example method to modify the prompt
    def modify_prompt(self, prompt):
        model = TaggerLlama()
        # Implement your prompt modification logic here
        # For example, adding a prefix or replacing certain words
        predicted_tags = model.predict_tags(prompt)
        formatted_tags = ', '.join(predicted_tags)
